...
onready var character_label := $Balloon/Margin/HBox/VBox/Character
onready var dialogue_label := $Balloon/Margin/HBox/VBox/Dialogue
onready var responses_menu := $Balloon/Margin/HBox/VBox/Responses
onready var character_portrait := $Balloon/Margin/HBox/Portrait/Sprite
...
func _ready() -> void:
	...
	if dialogue_line.character != "":
		...
		var pngname = dialogue_line.character.replace(" ", "_")
		character_portrait.texture = load("res://Assets/Portrait/%s.png" % dialogue_line.character)
	else:
